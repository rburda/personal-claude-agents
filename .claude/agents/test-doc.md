...
## Examples
1. User needs sample markdown files for testing a documentation parser. 
...
```
2. User is setting up test fixtures and needs markdown content.
...
<Task tool invocation to launch markdown-file-generator agent>
```
3. User needs mock README files for testing.
